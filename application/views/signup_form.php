...
<div id="container">
	...
	<div id="body">
		...
		<tr>
		<td> </td>
		<td> <?php echo form_open('login/create_member'); ?> </td>
		</tr>
		...
		<tr>
		<td> Password :</td>
		<td> <?php echo form_password('password','','placeholder = "" class="password"'); ?></td>
		</tr>
		...
		<td> <?php echo form_password('password_confirm','','placeholder = "" class="password_confirm"'); ?> </td>
		</tr>
